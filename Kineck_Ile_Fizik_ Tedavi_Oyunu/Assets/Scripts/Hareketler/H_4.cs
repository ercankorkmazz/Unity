...
public class H_4 : MonoBehaviour
{
    GameObject GameControler_Object;
    GameController myGameController;
    public GameObject H4_Bekleme_Sayaci;
    public GameObject H4_Bekleme_SayaciText;
    ...
    void Start()
    {
        ...
        if (beklemeSayaci > 0)
        {
            ...
            H4_Bekleme_SayaciText.GetComponent<Text>().text = beklemeSayaci.ToString();
        }
        else
            Sayac = 10;

        GameObject ZamanSayaci = GameObject.Find("H4_SayacText");
        ZamanSayaci.GetComponent<Text>().text = Mathf.RoundToInt(Sayac).ToString();
    }
    void Update()
    {
        if (GameController.Hareket_4 == 2)
        {
    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            {
                H4_Bekleme_Sayaci.SetActive(true);
        ...
        GameObject ZamanSayaciTXT = GameObject.Find("H4_SayacText");
        ZamanSayaciTXT.GetComponent<Text>().text = Mathf.RoundToInt(Sayac).ToString();

        H4_Bekleme_SayaciText.GetComponent<Text>().text = Mathf.RoundToInt(beklemeSayaci).ToString();
    }
}

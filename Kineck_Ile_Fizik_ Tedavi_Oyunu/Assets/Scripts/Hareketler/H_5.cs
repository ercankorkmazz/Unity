...
public class H_5 : MonoBehaviour
{
    GameObject GameControler_Object;
    GameController myGameController;
    public GameObject H5_Bekleme_Sayaci;
    public GameObject H5_Bekleme_SayaciText;
    ...
    void Start()
    {
        ...
        if (beklemeSayaci > 0)
        {
            ...
            H5_Bekleme_SayaciText.GetComponent<Text>().text = beklemeSayaci.ToString();
        }
        else
            Sayac = 10;

        GameObject ZamanSayaci = GameObject.Find("H5_SayacText");
        ZamanSayaci.GetComponent<Text>().text = Mathf.RoundToInt(Sayac).ToString();
    }
    void Update()
    {
        if (GameController.Hareket_5 == 2)
        {
    ...
    void FixedUpdate()
    {
        ...
        else
        {
            ...
            {
                H5_Bekleme_Sayaci.SetActive(true);
        ...
        GameObject ZamanSayaciTXT = GameObject.Find("H5_SayacText");
        ZamanSayaciTXT.GetComponent<Text>().text = Mathf.RoundToInt(Sayac).ToString();

        H5_Bekleme_SayaciText.GetComponent<Text>().text = Mathf.RoundToInt(beklemeSayaci).ToString();
    }
}
